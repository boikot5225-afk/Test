...
sed -i 's/versionCode 2/versionCode 14/' "$BUILD_FILE"
sed -i "s/versionName 'stage1-test'/versionName 'lingq-a54-v0.9.0'/" "$BUILD_FILE"
...
grep -F 'versionCode 14' "$BUILD_FILE"
grep -F "versionName 'lingq-a54-v0.9.0'" "$BUILD_FILE"
...
grep -F "reader-app.js?v=77.33-zh-context" "$WWW/js/app.js"
grep -F "v77.33-zh-context-stable" "$WWW/sw.js"
...
echo "Galaxy A54 v0.9 Chinese-stable wrapper prepared successfully"
