...
replace_once('js/reader/chapter-render-next.js', "./interactions-runtime.js?v=2", "./interactions-runtime.js?v=3-known-collapse")
replace_once('js/reader/chapter-render-stage1.js', "./chapter-render-next.js?v=14", "./chapter-render-next.js?v=15-known-collapse")
replace_once('js/reader/chapter-render-dialogue.js', "./chapter-render-stage1.js?v=12", "./chapter-render-stage1.js?v=13-known-collapse")
replace_once('js/reader/chapter-render.js', "./chapter-render-dialogue.js?v=10", "./chapter-render-dialogue.js?v=11-known-collapse")
replace_once('js/reader-app.js', "./reader/chapter-render.js?v=12", "./reader/chapter-render.js?v=13-known-collapse")
