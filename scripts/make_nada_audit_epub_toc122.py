...
<package xmlns="http://www.idpf.org/2007/opf" unique-identifier="bookid" version="2.0"><metadata xmlns:dc="http://purl.org/dc/elements/1.1/"><dc:title>Nada — toc122 runtime audit</dc:title><dc:creator>Jean-Patrick Manchette</dc:creator><dc:language>fr</dc:language><dc:identifier id="bookid">nada-toc122-audit</dc:identifier></metadata><manifest><item id="ch1" href="chapter.xhtml" media-type="application/xhtml+xml"/></manifest><spine><itemref id="ch1"/></spine></package>''', encoding='utf-8')
passages = [
