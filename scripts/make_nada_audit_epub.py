...
root = Path('runtime-audit/epub-src')
...
<package xmlns="http://www.idpf.org/2007/opf" unique-identifier="bookid" version="2.0"><metadata xmlns:dc="http://purl.org/dc/elements/1.1/"><dc:title>Nada — runtime audit</dc:title><dc:creator>Jean-Patrick Manchette</dc:creator><dc:language>fr</dc:language><dc:identifier id="bookid">nada-runtime-audit</dc:identifier></metadata><manifest><item id="ch1" href="chapter.xhtml" media-type="application/xhtml+xml"/></manifest><spine><itemref idref="ch1"/></spine></package>''', encoding='utf-8')
passages = [
...
out = Path('runtime-audit/nada-runtime.epub')
