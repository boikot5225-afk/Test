...
import './ja-vocab-estimate.js?v=4-kana'; // Japanese: Known/Unknown from a frequency test
import './ja-readable-inline.js?v=4-kana'; // Japanese: kana reading above the word, Russian below it
import './ja-context-batch.js?v=4-kana'; // Japanese: ask DeepSeek for the Unknown words on screen
