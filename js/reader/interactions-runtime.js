...
import './ja-vocab-estimate.js?v=5-as-written'; // Japanese: Known/Unknown from a frequency test
import './ja-readable-inline.js?v=5-as-written'; // Japanese: kana reading above the word, Russian below it
import './ja-context-batch.js?v=5-as-written'; // Japanese: ask DeepSeek for the Unknown words on screen
