...
import './handler-bridge.js?v=2-stt-background';
...
import './ja-vocab-estimate.js?v=6-tts-cache'; // Japanese: Known/Unknown from a frequency test
import './ja-readable-inline.js?v=6-tts-cache'; // Japanese: kana reading above the word, Russian below it
import './ja-context-batch.js?v=6-tts-cache'; // Japanese: ask DeepSeek for the Unknown words on screen
